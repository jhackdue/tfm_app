...
import sys
sys.path.append("..")
import api_utils.train.exactMatch as eM  # noqa: E402
import api_utils.utils.read_and_write as rw  # noqa: E402

ABS_PATH = "./api_utils/"
CHK_PATH = os.path.join(ABS_PATH, "data/checkpoints/")
LOGS_PATH = os.path.join(ABS_PATH, "data/logs/tensorboard/")
